...
//    public static void syncDecodeProcessData(byte[] data, int width, int height, boolean isRetry){
//        try {
...
//                if (rawResult != null) {
//                    QRCodeUtil.e("GlobalHistogramBinarizer 没识别到，HybridBinarizer 能识别到");
//                }
//            }
//        } catch (Exception e) {
